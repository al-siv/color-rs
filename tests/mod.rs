...
mod test_suite_runner {
    ...
    fn test_mathematical_foundations() {
        ...
        assert_eq!(unit::hue_analysis_tests::calculate_hue_distance(0.0, 180.0), 180.0);
        assert_eq!(unit::hue_analysis_tests::calculate_hue_distance(350.0, 10.0), 20.0);
    ...
    fn test_cli_interface() {
        ...
        assert!(unit::hue_cli_tests::validate_hue_args_basic(&normalized_args));
    ...
    fn test_collection_integration() {
        ...
        let filtered = unit::hue_integration_tests::filter_collection_by_hue(&css_colors, 180.0, 30.0);
        assert!(filtered.len() <= css_colors.len());
        
        // Cross-collection consistency
        let consistency_check = unit::hue_integration_tests::validate_cross_collection_consistency();
    ...
    fn test_performance_suite() {
        ...
        let _filtered = unit::hue_integration_tests::filter_collection_by_hue(&large_collection, 120.0, 30.0);
        let filter_elapsed = filter_start.elapsed();
        assert!(filter_elapsed.as_millis() < 1000, "Collection filtering too slow");
    ...
    fn test_workflow_integration() {
        ...
        // Filter colors
        let filtered = unit::hue_integration_tests::filter_collection_by_hue(&test_colors, target_hue, tolerance);
    ...
    fn run_mathematical_category_tests() {
        ...
        assert_eq!(unit::hue_analysis_tests::calculate_hue_distance(0.0, 0.0), 0.0);
        assert_eq!(unit::hue_analysis_tests::calculate_hue_distance(0.0, 180.0), 180.0);
        assert_eq!(unit::hue_analysis_tests::calculate_hue_distance(350.0, 10.0), 20.0);
        ...
        // Criteria tests
        assert!(unit::hue_analysis_tests::meets_hue_criteria(120.0, 120.0, 0.0));
        assert!(unit::hue_analysis_tests::meets_hue_criteria(110.0, 120.0, 15.0));
        assert!(!unit::hue_analysis_tests::meets_hue_criteria(90.0, 120.0, 15.0));
    ...
    fn run_integration_category_tests() {
        ...
        // Filtering
        let filtered_css = unit::hue_integration_tests::filter_collection_by_hue(&css_colors, 120.0, 30.0);
        let filtered_ral = unit::hue_integration_tests::filter_collection_by_hue(&ral_colors, 120.0, 30.0);
    ...
    fn run_stress_tests() {
        ...
        let _filtered = unit::hue_integration_tests::filter_collection_by_hue(&large_collection, 0.0, 1.0);
        let elapsed = start.elapsed();
        assert!(elapsed.as_secs() < 10, "Large collection stress test too slow");
        ...
        for _ in 0..1000 {
            ...
            let _filtered = unit::hue_integration_tests::filter_collection_by_hue(&temp_collection, 180.0, 30.0);
