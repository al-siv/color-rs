...
impl FileOutputService {
    ...
    pub fn write_to_file<S: FileOutputStrategy>(
        ...
        println!("Color analysis saved to {} file: {}", strategy.format_name(), filename);
        Ok(())
    }
    ...
    fn ensure_extension(filename: &str, extension: &str) -> String {
        ...
        match path.extension() {
            ...
            _ => format!("{}.{}", filename.trim_end_matches(&format!(".{}", extension)), extension),
        }
    }
...
mod tests {
    ...
    fn create_test_data() -> ColorAnalysisOutput {
        ColorAnalysisOutput::new()
            .with_input("red".to_string(), "#FF0000".to_string())
    }
